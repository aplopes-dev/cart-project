...
export default {
  ...
  auth: {
    ...
    noProjectsTitle: 'Access Denied',
    noProjectsMessage: 'You do not have any projects associated with your account and cannot access the system.',
    noProjectsContact: 'Please contact the administrator to request access to a project.',
  ...
  checkout: {
    ...
    errorLoadingStates: 'Error loading states',
