<template>
  ...
  <div v-if="show && !showDeleteConfirmation" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
    <div class="flex items-center justify-center h-full translate-y-[-10%]">
      <div class="relative bg-white w-full max-w-3xl mx-4 rounded-xl shadow-2xl overflow-hidden">
        <div class="flex flex-col h-full">
          <!-- Header -->
          <div class="px-8 py-6 border-b border-gray-100">
            <div class="flex justify-between items-center">
              <h3 class="font-archivo-narrow font-semibold text-2xl text-gray-900">
          ...
          <div class="px-8 py-6">
            <form @submit.prevent="handleSubmit" class="space-y-6">
              <div class="grid grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                  ...
                  <input 
                    ...
                    type="text"
                    class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-empire-yellow focus:ring-2 focus:ring-empire-yellow/20 transition-all outline-none"
                    required
                  >
                </div>
              ...
              <div class="flex justify-end gap-4 mt-8 pt-6 border-t border-gray-100">
                ...
                <button
                  type="submit"
                  class="px-6 py-3 bg-empire-yellow text-black rounded-lg hover:bg-empire-yellow/90 transition-colors font-medium"
                >
