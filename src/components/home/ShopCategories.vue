<template>
  <section class="flex flex-col items-center py-12 md:py-24 px-4 md:px-6 gap-4 md:gap-6 w-full bg-white">
    <div class="flex flex-col items-center gap-4 md:gap-6 max-w-[1346px]">
      <!-- Title -->
      <h2 class="w-full text-2xl sm:text-3xl md:text-[45px] leading-normal md:leading-[72px] font-semibold font-archivo-narrow text-center text-black/70">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 w-full">
        ...
        <div class="flex flex-col items-start gap-4 md:gap-6 cursor-pointer" @click="navigateToCategory(firstThreeCategories[0]?.id)">
          <div class="flex flex-row items-center w-full">
            <!-- Icon Container -->
            <div class="w-[80px] h-[80px] md:w-[120px] md:h-[120px] bg-[#FFDD00] flex justify-center items-center">
        ...
        <!-- Category Card - Tools -->
        <div class="flex flex-col items-start gap-4 md:gap-6 cursor-pointer" @click="navigateToCategory(firstThreeCategories[1]?.id)">
          <div class="flex flex-row items-center w-full">
            <!-- Icon Container -->
            <div class="w-[80px] h-[80px] md:w-[120px] md:h-[120px] bg-[#FFDD00] flex justify-center items-center">
              <svg class="w-16 h-16" viewBox="0 0 64 64">
        ...
        <div class="flex flex-col items-start gap-4 md:gap-6 cursor-pointer" @click="navigateToCategory(firstThreeCategories[2]?.id)">
          <div class="flex flex-row items-center w-full">
            <!-- Icon Container -->
            <div class="w-[80px] h-[80px] md:w-[120px] md:h-[120px] bg-[#FFDD00] flex justify-center items-center">
              <svg class="w-16 h-16" viewBox="0 0 64 64">
