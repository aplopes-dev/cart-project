    ...
    <div class="container mx-auto px-4">
      <div class="max-w-[1408px] mx-auto">
        ...
        <div class="page-title">
          <h1 class="font-archivo-narrow font-semibold text-4xl md:text-5xl text-center text-white">
            SHOPPING CART
          </h1>
        </div>

        <!-- Conteúdo do carrinho em um container branco -->
          ...
          <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-grow">
              ...
              <div v-else class="text-center py-8">
                <p class="font-archivo text-xl">Your cart is empty</p>
                <button 
                  @click="$router.push('/')" 
